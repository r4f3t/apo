...
namespace EFNorthwind
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = EFNorthwind.Format.Default)
        {
            switch (format)
            {
                case EFNorthwind.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case EFNorthwind.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case EFNorthwind.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case EFNorthwind.Format.Minimal:
